...
namespace DataBoundApp1.ViewModels
{
    public class MainViewModel : INotifyPropertyChanged
    {
        ...
        public void LoadData()
        {
            ...
            this.Items.Add(new ItemViewModel() { ID = "0", LineOne = "Top Stories", LineTwo = "", LineThree = "", Link = "http://feeds.feedburner.com/NdtvNews-TopStories" });
            this.Items.Add(new ItemViewModel() { ID = "1", LineOne = "Latest News", LineTwo = "", LineThree = "", Link = "http://feeds.feedburner.com/NDTV-LatestNews" });
            this.Items.Add(new ItemViewModel() { ID = "2", LineOne = "Trending News", LineTwo = "", LineThree = "",Link ="http://feeds.feedburner.com/NDTV-Trending" });
