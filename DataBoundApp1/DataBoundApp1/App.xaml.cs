...
namespace DataBoundApp1
{
    public partial class App : Application
    {
        ...
        */
        private static DataBoundApp1.ViewModels.Newsmodel viewModel = null;
        public static DataBoundApp1.ViewModels.Newsmodel ViewModel
        {
            ...
            get
            {
                if (viewModel == null)
                {
                    viewModel = new DataBoundApp1.ViewModels.Newsmodel();
                    viewModel.LoadData();
                }
